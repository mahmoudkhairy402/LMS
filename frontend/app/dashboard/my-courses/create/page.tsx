...
import { createCourse } from "@/store/thunks/courseThunks";
...
export default function CreateCoursePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      delete finalPayload.thumbnailFile;

      // Update the state so if the API call below fails, the user won't re-upload the same files again!
      setFormData(finalPayload);

      await dispatch(createCourse(finalPayload)).unwrap();
      toast.success("Course created successfully");
      router.push("/dashboard/my-courses");
    } catch (error: any) {
      toast.error(error.message || error || "Failed to create course");
    } finally {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20 relative">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-surface-900 dark:text-white">Create New Course</h1>
          <p className="text-surface-500 mt-1">Fill out the details to publish your course to students.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-surface-300 dark:border-surface-700  dark:bg-background focus:-2 focus: rounded-none dark:bg-background"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2 border border-surface-300 dark:border-surface-700  dark:bg-background focus:-2 focus: rounded-none capitalize dark:bg-background"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2 border border-surface-300 dark:border-surface-700 dark:bg-background focus:ring-2 rounded-none capitalize"
                  >
            ...
            <div className="space-y-4">
              <div>
                ...
                {formData.thumbnail && formData.thumbnail.startsWith("blob:") && (
                  <div className="mt-2 text-sm text-green-500">Image selected successfully.</div>
                )}
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2 border border-surface-300 dark:border-surface-700  dark:bg-background focus:-2 focus: rounded-none resize-y dark:bg-background"
              ...
              <div>
                ...
                <div className="border border-surface-300 dark:border-surface-700  dark:bg-background p-2 flex flex-wrap gap-2 dark:bg-background">
                  ...
                  <input
                    ...
                    className="flex-grow min-w-[120px] focus:ine-none bg-transparent"
              ...
              <div className="flex items-center space-x-3 pt-4 border-t border-surface-200 dark:border-surface-700">
                <input
                  ...
                  onChange={handleChange}
                  className="w-5 h-5 text-primary-500  dark:bg-background border-surface-300 dark:border-surface-700 focus: focus:-2 rounded-none"
                />
                  ...
                  <div className="bg-surface-100 dark:bg-surface-800 p-3 flex justify-between items-center border-b border-surface-300 dark:border-surface-700">
                    <div className="flex items-center flex-grow space-x-3">
                      ...
                      <input
                        ...
                        className="font-bold bg-transparent border-none focus:-0 p-0 text-surface-900 dark:text-white w-full"
                      />
                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              ...
                              {lesson.videoUrl && lesson.videoUrl.startsWith("blob:") && (
                                <div className="text-xs text-green-500">Video selected successfully.</div>
                              )}
                            </div>
                          </div>
                          <div>
                          ...
                          <div className="flex items-center mt-2">
                            <input
                              ...
                              className="w-4 h-4 text-primary-500 border-surface-300 focus:"
                            />
        ...
        <div className="flex justify-between items-center pt-4">
          ...
          >
            {isSubmitting ? "Processing..." : step === 3 ? "Create Course" : "Continue"}
          </button>
        </div>
      </form>
    </div>
